...
def generate_dns_packets (src_ip, dst_ip):
    dns_rqst = Ether(src='00:15:17:a7:75:a3', dst='e0:5f:b9:69:e9:22')/IP(src=src_ip,dst=dst_ip,version=4)/UDP(dport=53, sport=1030)/DNS(rd=1,qd=DNSQR(qname="www.cisco.com"))
    dns_resp = Ether(src='e0:5f:b9:69:e9:22', dst='00:15:17:a7:75:a3')/IP(src=dst_ip,dst=src_ip,version=4)/UDP(dport=1030, sport=53)/DNS(aa=1, qr=1, an=DNSRR(rclass=1, rrname='www.cisco.com.', rdata='100.100.100.100', type=1), ad=0, qdcount=1, ns=None, tc=0, rd=0, ar=None, opcode=0, ra=1, cd=0, z=0, rcode=0, qd=DNSQR(qclass=1, qtype=1, qname='www.cisco.com.'))
